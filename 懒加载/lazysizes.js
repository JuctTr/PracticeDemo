        ...
        var loader = (function () {
            ...
            var checkElements = function () {
                var eLlen,
                    ...
                    preloadExpand,
                    hFac;
                var lazyloadElems = lazysizes.elements; // html页面的懒加载元素标签（如：img标签等）
                ...
                if ((loadMode = lazySizesCfg.loadMode) && isLoading < 8 && (eLlen = lazyloadElems.length)) {
                    ...
                    for (; i < eLlen; i++) {
                        ...
                        if (
                            ...
                            // 这个函数后面 会调用 lazyUnveil 把 data-src 赋给 真实的src
                            unveilElement(lazyloadElems[i]);
